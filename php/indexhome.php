        ...
        <nav class="container">
            ...
            <div class="nav-content">
                ...
                <div class="logo-container">
                    <a href="indexhome.html" class="logo-link">
                        Gestão Energia
                    </a>
                </div>
                ...
                <div class="nav-links">
                    <a href="indexhome.html" class="nav-link nav-link--active">Home</a>
                    <a href="gerenciar.html" class="nav-link">Gerenciar Cadastros</a>
                    <? echo $_SESSION['nome'];?>
        ...
        <section class="content-section">
            <div class="content-grid-two-cols">
                ...
                <div class="content-text">
                    ...
                    -->
                    <a href="visualizar.html" class="btn-primary btn-inline" id="btn-acessar">
                        Acessar Painel de Dados
                    </a>
                </div>
                
                <div class="content-image-wrapper">
                    <img src="tipos-de-energia.webp" 
